...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>web ini dibuat untuk pembelajaran P4 di Universitas Pancasila</p>
                </div>
                <div class="col-lg-4">
                    <p>diharapkan dengan membuat website ini dapat meningkatkan pengalaman dalam pembuatan website</p>
					</div>
    ...
    <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>West Java<br>Depok</p>
                    </div>
                    <div class="footer-col col-md-4">
                        <h3>Around the Web</h3>
                        <ul class="list-inline">
                            <li>
                                <a href="https://www.facebook.com/zaenardo" class="btn-social btn-outline"><i class="fa fa-fw fa-facebook"></i></a>
                            </li>
                            <li>
                                <a href="#" class="btn-social btn-outline"><i class="fa fa-fw fa-google-plus"></i></a>
                            </li>
                            <li>
                                <a href="https://www.twitter.com/zaenardo" class="btn-social btn-outline"><i class="fa fa-fw fa-twitter"></i></a>
                            </li>
                            <li>
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Zaenardo, Zein Muhammad Firdaus 2015
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="${request.contextPath}/js/classie.js"></script>
    <script src="${request.contextPath}/js/cbpAnimatedHeader.js"></script>
    ...
    <script src="${request.contextPath}/js/freelancer.js"></script>
